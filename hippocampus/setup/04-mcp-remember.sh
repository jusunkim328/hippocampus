...
print(json.dumps({
    ...
    'type': 'mcp',
    'description': '새로운 경험을 조직 지식으로 저장합니다. 인시던트 해결 후 또는 사용자가 저장을 요청할 때 사용합니다. 대화에서 핵심 사실을 SPO 트리플(entity/attribute/value)로 구조화하고 3개 인덱스에 기록합니다. 저장 완료 후 반드시 Experience Grade를 표시하세요.',
